...
def coin_flip(points,question_count):
    print("""Well done, you've answered {} questions!
Every 3 questions you complete you have the option to flip a coin and
gamble your Koru You currently have {} Koru(s).""".format(question_count,points))
    # Flip a coin.
    flip = input("Would you like to flip the coin?: ")
    if flip == "yes":
        ...
        if coin == 0:
            ...
            print("Tails!")
            points = (points*2)
            print("You double your points! You now have {} korus".format(points))
